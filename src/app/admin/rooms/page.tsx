    ...
    try {
      ...
      const sanitizedData = {
        ...
        hallName: formData.hallName
          ? sanitizeText(formData.hallName)
          : undefined,
        roomNumber: formData.roomNumber
          ? sanitizeText(formData.roomNumber)
          : undefined,
        campus: formData.campus ? sanitizeText(formData.campus) : undefined,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rooms.map((room) => (
              <Card key={room.id} className="overflow-hidden">
                ...
                <CardHeader>
                  <CardTitle className="text-lg">{room.displayName}</CardTitle>
                  <CardDescription>
                    {room.hallName &&
                      room.roomNumber &&
                  ...
                  <CardDescription>
                    {room.votes.length} vote{room.votes.length !== 1 ? 's' : ''}
                  </CardDescription>
                </CardHeader>
                <CardContent>
